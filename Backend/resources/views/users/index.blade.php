                ...
                <tbody>
                    @forelse ($users as $user)
                        <tr>
                            ...
                            <td><span class="badge bg-{{ $user->user_role == 'admin' ? 'danger' : 'primary' }}">{{ ucfirst($user->user_role) }}</span></td>
                            <td>
                                ...
                                <form method="POST" action="/users/{{ $user->user_id }}" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
